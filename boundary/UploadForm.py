...
class UploadForm(QDialog):
    ...
    def displayPreview(self, file_path):
        ...
        if not pixmap.isNull():
            w = self.lblPreview.width() if self.lblPreview.width() > 0 else 500
            h = self.lblPreview.height() if self.lblPreview.height() > 0 else 200
    ...
    def uploadPhoto(self):
        ...
        if self.photo:
            ...
            if success:
                ...
                if self.parent and hasattr(self.parent, "refreshParamText"):
